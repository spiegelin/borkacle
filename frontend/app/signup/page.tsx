    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex justify-center">
          <div className="h-12 w-12 rounded-md bg-[#F7630C] flex items-center justify-center text-white font-bold text-xl">
            O
          </div>
        </div>
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          ...
          <Link href="/login" className="font-medium text-[#F7630C] hover:text-[#E25A00]">
            Sign in
          </Link>
        </p>
      </div>
              ...
              <div className="flex flex-col items-center">
                <div
                  className={`h-8 w-8 rounded-full flex items-center justify-center ${
                    step >= 1 ? "bg-[#F7630C] text-white" : "bg-gray-200 text-gray-500"
                  }`}
                >
                  {step > 1 ? <Check className="h-5 w-5" /> : "1"}
                </div>
                <span className="mt-1 text-xs text-gray-500">Account</span>
              </div>
              <div className={`flex-1 h-1 mx-2 ${step >= 2 ? "bg-[#F7630C]" : "bg-gray-200"}`}></div>
              <div className="flex flex-col items-center">
                <div
                  className={`h-8 w-8 rounded-full flex items-center justify-center ${
                    step >= 2 ? "bg-[#F7630C] text-white" : "bg-gray-200 text-gray-500"
                  }`}
                >
                  {step > 2 ? <Check className="h-5 w-5" /> : "2"}
                </div>
                <span className="mt-1 text-xs text-gray-500">Password</span>
              </div>
              <div className={`flex-1 h-1 mx-2 ${step >= 3 ? "bg-[#F7630C]" : "bg-gray-200"}`}></div>
              <div className="flex flex-col items-center">
                <div
                  className={`h-8 w-8 rounded-full flex items-center justify-center ${
                    step >= 3 ? "bg-[#F7630C] text-white" : "bg-gray-200 text-gray-500"
                  }`}
                >
                  3
                </div>
                <span className="mt-1 text-xs text-gray-500">Company</span>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <Button
                    ...
                    className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#F7630C] hover:bg-[#E25A00] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F7630C]"
                  >
                    Next
